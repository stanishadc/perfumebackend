...
export default function OrderDetails(props) {
    ...
    const applicationAPI = () => {
        return {
            ...
            update: (id, updateRecord) => axios.put("https://papi.perfumatory.shop/api/order/update/" + id, updateRecord),
            UpdateShippingDate: (id, updateRecord) => axios.put("https://papi.perfumatory.shop/api/order/UpdateShippingDate/" + id, updateRecord),
